...
bool use_wifi = true;
const char *ssid{"JCOM_JMJU"};          // write your WiFi SSID (2.4GHz)
const char *password{"343875335415"};  // write your WiFi password
#else
bool use_wifi = false;
...
unsigned int channelId{34281};                         // write your Ambient channel ID
const char *writeKey{"eb7f3f74949e1eb1"};  // write your Ambient write key
#else
